...
export function Logo({ size = 28 }: { size?: number }) {
  return (
    <div role="img" aria-label="LEAP" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      <div style={{
        ...
        <svg width={size * 0.55} height={size * 0.55} viewBox="0 0 24 24" fill="none" aria-hidden focusable="false">
